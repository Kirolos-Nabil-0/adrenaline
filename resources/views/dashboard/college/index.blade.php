...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Colleges /</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> All
                    Colleges
                </span>
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="col-sm-6 col-md-4 col-xl-3 p-3">
                    <a class="modal-effect btn btn-outline-primary btn-inline-block" data-effect="effect-scale"
                        data-toggle="modal" href="#modaldemo8">Add College</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap" id="collages">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">College</th>
                                    <th class="wd-15p border-bottom-0">Its affiliated university</th>
                                    <th class="wd-15p border-bottom-0">College Image</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <div class="main-toggle main-toggle-success {{ $color->status == true ? 'on' : '' }} btn-sm ml-2"
                                                    data-banner-id="{{ $color->id }}">
                                                    <span></span>
                                                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Collage</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('college.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <label for="exampleInputEmail1">Uinversity</label>
                            ...
                            <div class="form-group">
                                <label for="image">Upload a picture of the Collage</label>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Collage</h5>
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Delete Collage</h6>
                        <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route('college.destroy', 0) }}" method="POST">
                        {{ method_field('POST') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
...
@section('page_js')
    <script>
        $(document).ready(function() {
            $('#collages').on('click', '.main-toggle', function() {
                $(this).toggleClass('on');
                var isToggleOn = $(this).hasClass('on');
                var url = '{{ route('college.update-status') }}';
