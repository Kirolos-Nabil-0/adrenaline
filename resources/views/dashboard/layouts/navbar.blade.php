...
{{-- <div class="navbar-dashboard-site">
    ...
    <div class="right-side-navbar">
        ...
        <div class="profile-user">
            <img style="width:40px;height:40px;border-radius:50%" src="{{asset($currentUser->profile_photo_path??'images/1.png')}}" alt="">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ asset($currentUser->profile_photo_path ?? 'images/1.png') }}"></a>
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('settings') }}"><i class="bx bx-cog"></i> Edit
                            Profile</a>
                        <a class="dropdown-item" href="{{ route('settings') }}"><i class="bx bx-slider-alt"></i>
                            Account Settings</a>
                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-log-out"></i> Sign
                            Out</a>
						<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
                        </form>
