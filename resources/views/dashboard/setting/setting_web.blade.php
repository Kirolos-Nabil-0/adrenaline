...
<h2 class="mt-3">Movable Bonds</h2>

<div class="tab">
    <button class="tablinks" onclick="openTab(event, 'Tab1')" id="defaultOpen">عنا</button>
    <button class="tablinks" onclick="openTab(event, 'Tab2')">الشروط والأحكام</button>
    <button class="tablinks" onclick="openTab(event, 'Tab3')">سياسية الخصوصية</button>
...
<div id="Tab1" class="tabcontent">
    <form action="{{ route('settings.update') }}" method="POST">
        ...
        <div class="form-group col-lg-6">
            <label for="cortitle">Introductory video of the application<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id="video_link" name="video_link"
                value="{{ $settings->video_link }}" placeholder=" Enter Introductory video of the application">

        </div>
        <div class="form-group col-lg-6">
            <label for="cortitle">Phone number<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id="phone_number" name="phone_number"
                value="{{ $settings->phone_number }}" placeholder="Enter phone number">
        </div>
        <div class="form-group col-lg-6">
            <label for="cortitle">Telegram<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id="telegram" name="telegram"
                value="{{ $settings->telegram }}" placeholder="Enter telegram">
        </div>
        <div class="form-group col-lg-6">
            <label for="cortitle">Dollar price<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id="dooler_price" name="dooler_price"
                value="{{ $settings->dooler_price }}" placeholder="dollar price" required>
        </div>
        <div class="form-group col-lg-6">
            <label for="exampleInputEmail1">Test mode</label>
            <select id="is_debug_7" name="is_debug_7" class="form-control SlectBox" required>
                <option value="1" @if ($settings->is_debug_7 == '1') selected @endif>true</option>
                <option value="0" @if ($settings->is_debug_7 == '0') selected @endif>false</option>
            </select>
        </div>
        <br>
        <!-- <h5>About Us</h5>
        ...
        <!-- <h5>Information about us in English</h5>
        <br>
...
<div id="Tab2" class="tabcontent">
    <form action="{{ route('settings.update') }}" method="POST">
        ...
        <!-- <h5>Terms and conditions in English</h5>
        <br>
...
<div id="Tab3" class="tabcontent">
    <form action="{{ route('settings.update') }}" method="POST">
        ...
        <br>
        <br>
        <!-- <h5>Privacy Policy in English</h5>
        <br>
        <textarea id="privacy_en" name="privacy_en" rows="15">{{ $settings->privacy_en }}</textarea> -->
        <button class="btn btn-primary w-100 mt-2">حفظ</button>
    </form>
